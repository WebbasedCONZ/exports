          ...
          <div key={alert.id} className="bg-[#ff4444]/5 border border-[#ff4444]/30 rounded-md p-4 animate-pulse-once">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-lg font-bold text-[#3d52ff] mt-2">
                ...
                <div className="flex gap-2 mt-3">
                  <button onClick={() => accept(alert.id, alert.slot_id)}
                    className="flex-1 py-2 bg-[#3d52ff] text-black text-sm font-semibold rounded-sm hover:bg-[#2a3fe0] transition-colors">
                    Accept Slot
                  </button>
